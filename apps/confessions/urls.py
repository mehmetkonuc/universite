...
from apps.confessions.views import ConfessionsAddView, ConfessionsView, ConfessionDetailView, ConfessionsEditView, delete_confessions, MyConfessionsView, DraftConfessionsView
urlpatterns = [
    path('', ConfessionsView.as_view(), name='confessions'),
    path('my/', MyConfessionsView.as_view(), name='my_confessions'),
    path('draft/', DraftConfessionsView.as_view(), name='my_draft_confessions'),
